...
)
{
  ...
  if ( state & CRUDE_GFX_RESOURCE_STATE_RENDER_TARGET )     return VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL;
  if ( state & CRUDE_GFX_RESOURCE_STATE_DEPTH_WRITE )       return VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL;
  if ( state & CRUDE_GFX_RESOURCE_STATE_DEPTH_READ )        return VK_IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL;
  if ( state & CRUDE_GFX_RESOURCE_STATE_UNORDERED_ACCESS )  return VK_IMAGE_LAYOUT_GENERAL;
  if ( state & CRUDE_GFX_RESOURCE_STATE_SHADER_RESOURCE )   return VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
