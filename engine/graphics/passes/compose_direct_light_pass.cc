...
void
crude_gfx_compose_direct_light_pass_initialize
(
  _In_ crude_gfx_compose_direct_light_pass                *pass,
...
void
crude_gfx_compose_direct_light_pass_deinitialize
(
  _In_ crude_gfx_compose_direct_light_pass                *pass
)
{
...
void
crude_gfx_compose_direct_light_pass_pre_render
(
  _In_ void                                               *ctx,
...
void
crude_gfx_compose_direct_light_pass_render
(
  _In_ void                                               *ctx,
  _In_ crude_gfx_cmd_buffer                               *primary_cmd
)
{
  ...
  pipeline = crude_gfx_access_technique_pass_by_name( gpu, "fullscreen", "compose_direct_light" )->pipeline;
...
crude_gfx_compose_direct_light_pass_pack
(
  _In_ crude_gfx_compose_direct_light_pass                             *pass
)
{
  ...
  container.ctx = pass;
  container.render = crude_gfx_compose_direct_light_pass_render;
  container.pre_render = crude_gfx_compose_direct_light_pass_pre_render;
  return container;
}