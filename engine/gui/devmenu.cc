...
)
{
  ...
  if ( ImGui::CollapsingHeader( "Global Illumination" ) )
  {
    ...
    ImGui::DragFloat3( "Probe Grid Position", &dev_scene_rendere->devmenu->engine->scene_renderer.options.indirect_light.probe_grid_position.x );
    ImGui::DragFloat3( "Probe Spacing", &dev_scene_rendere->devmenu->engine->scene_renderer.options.indirect_light.probe_spacing.x );
    ImGui::DragFloat( "Max Probe Offset", &dev_scene_rendere->devmenu->engine->scene_renderer.options.indirect_light.max_probe_offset );
    ImGui::DragFloat( "Self Shadow Bias", &dev_scene_rendere->devmenu->engine->scene_renderer.options.indirect_light.self_shadow_bias );
    ImGui::SliderFloat( "Hysteresis", &dev_scene_rendere->devmenu->engine->scene_renderer.options.indirect_light.hysteresis, 0.0, 1.0 );
    ImGui::DragFloat( "Shadow Weight Power", &dev_scene_rendere->devmenu->engine->scene_renderer.options.indirect_light.shadow_weight_power );
    ImGui::SliderFloat( "Infinite Bounces Multiplier", &dev_scene_rendere->devmenu->engine->scene_renderer.options.indirect_light.infinite_bounces_multiplier, 0.0, 1.0 );
    ImGui::DragInt( "Probe Update Per Frame", &dev_scene_rendere->devmenu->engine->scene_renderer.options.indirect_light.probe_update_per_frame );
    ImGui::Text( "Probe Debug Flags" );
    ImGui::CheckboxFlags( "Statues | OV", &dev_scene_rendere->devmenu->engine->scene_renderer.options.indirect_light.probe_debug_flags, 1 );
    ImGui::CheckboxFlags( "Radiance | OV", &dev_scene_rendere->devmenu->engine->scene_renderer.options.indirect_light.probe_debug_flags, 2 );
    ImGui::CheckboxFlags( "Probe Index | OV", &dev_scene_rendere->devmenu->engine->scene_renderer.options.indirect_light.probe_debug_flags, 4 );
