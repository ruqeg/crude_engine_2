...
#define CRUDE_HASHMAP_INITIALIZE( h, l ) ( ( h ) = NULL, ( h ) = CRUDE_REINTERPRET_CAST( CRUDE_TYPE( h ), crude_hashmap_growf( NULL, sizeof*( h ), CRUDE_CORE_HASHMAP_INITIAL_CAPACITY, ( l ) ) ) )
