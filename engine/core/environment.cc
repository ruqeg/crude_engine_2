...
)
{
  ...
  
  {
    ...
    techniques_relative_directory = cJSON_GetStringValue( cJSON_GetObjectItemCaseSensitive( directories_json, "techniques_relative_directory" ) );
    ...
    environment->directories.techniques_absolute_directory_length = working_absolute_directory_length + crude_string_length( techniques_relative_directory );
    ...
    constant_string_buffer_size += environment->directories.techniques_absolute_directory_length;
