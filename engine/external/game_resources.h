...
/* Player */
#define CRUDE_GAME_PLAYER_SANITY_LIMIT ( 3 * 60 )
#define CRUDE_GAME_PLAYER_DRUG_WITHDRAWAL_LIMIT ( 2.25 * 60 )
#define CRUDE_GAME_PLAYER_HEALTH_DAMAGE_FROM_ENEMY ( 0.167 )
...
#define CRUDE_GAME_ENEMY_HIT_DEALE_STANNE_TIME 1.5
#define CRUDE_GAME_ENEMY_HIT_RECEIVE_STANNE_TIME 0.0
#define CRUDE_GAME_ENEMY_CRITICAL_HIT_RECEIVE_STANNE_TIME 5.0
