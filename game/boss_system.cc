...
)
{
  ...
  for ( uint32 i = 0; i < it->count; ++i )
  {
    ...
    XMStoreFloat3( &boss_bullet_transform->translation, XMVectorAdd( XMLoadFloat3( &boss_bullet_transform->translation ), XMVectorScale( dir, boss_fight->type ? it->delta_time * 90.0f : it->delta_time * 50.0f ) ) ); 
