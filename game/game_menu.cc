...
)
{
  ...
  //      { game->engine->gpu.vk_swapchain_width / 2.f - 200.f, 20.f },
  //      { game->engine->gpu.vk_swapchain_width / 2.f + 200.f, 40.f },
  //      bg_color
  //    );
  //    
  //    draw_list->AddRectFilled(
  //      { game->engine->gpu.vk_swapchain_width / 2.f - 200.f, 20.f },
  //      { game->engine->gpu.vk_swapchain_width / 2.f + 200.f - 400.f * ( 1.f - ( boss->health_eye_0 + boss->health_eye_1 + boss->health_eye_2 ) / 3.f ), 40.f },
  //      hp_color
  //    );
  //  }
  //  else
