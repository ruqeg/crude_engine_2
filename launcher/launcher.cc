...
int main()
{
  ...
  cr_plugin                                                crude_sandbox_cr, crude_editor_cr, crude_paprika_cr, crude_engine_simulation_cr;
  ...
  crude_editor_cr.userdata            = engine.world;
  crude_engine_simulation_cr.userdata = &engine;
  crude_paprika_cr.userdata           = engine.world;
